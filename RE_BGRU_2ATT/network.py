...
class GRU:
	def __init__(self,is_training,word_embeddings,settings):
		...
		# embedding layer
		inputs_forward = tf.concat([tf.nn.embedding_lookup(word_embedding,self.input_word),tf.nn.embedding_lookup(pos1_embedding,self.input_pos1),tf.nn.embedding_lookup(pos2_embedding,self.input_pos2)],2)
		inputs_backward = tf.concat([tf.nn.embedding_lookup(word_embedding,tf.reverse(self.input_word,[1])),tf.nn.embedding_lookup(pos1_embedding,tf.reverse(self.input_pos1,[1])),tf.nn.embedding_lookup(pos1_embedding,tf.reverse(self.input_pos2,[1]))],2)
